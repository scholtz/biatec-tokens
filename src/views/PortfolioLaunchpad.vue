        ...
        >
          <div class="glass-effect rounded-xl p-8 max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-4 mb-6">
              <button
                class="p-2 rounded-lg text-gray-500 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
