    ...
    <Card variant="glass" padding="lg">
      <div class="text-center max-w-4xl mx-auto">
        ...
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">
          Compare features across multiple token standards to make informed decisions for your enterprise tokenization needs.
        </p>
          ...
          <div class="flex items-start space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-blue-800 dark:text-blue-300">
                This comparison matrix helps enterprise buyers evaluate token standard suitability for their specific use cases. 
                Features like <strong>whitelisting</strong> and <strong>compliance flags</strong> are critical for regulated environments, 
                while <strong>metadata support</strong> and <strong>programmable logic</strong> enable sophisticated business models. 
                Choose the right standard to ensure regulatory compliance, operational efficiency, and future scalability.
              </p>
            </div>
          </div>
        </div>
          ...
          <thead>
            <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
              ...
              <th
                ...
                :key="standard.name"
                class="px-6 py-4 text-center min-w-[140px]"
              >
