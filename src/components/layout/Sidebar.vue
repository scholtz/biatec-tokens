          ...
          <div class="mb-6">
            ...
            <div class="mt-3 space-y-1">
              ...
              <router-link
                ...
                :aria-current="isActive('/compliance/release') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/release')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
              ...
              <router-link
                ...
                :aria-current="isActive('/compliance/onboarding') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/onboarding')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
              ...
              <router-link
                ...
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/risk-report')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
                <ShieldExclamationIcon class="mr-3 h-5 w-5 shrink-0" aria-hidden="true" />
                Risk Report Builder
              </router-link>
              <router-link
                to="/compliance/approval"
                :aria-current="isActive('/compliance/approval') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/approval')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
                <ClipboardDocumentListIcon class="mr-3 h-5 w-5 shrink-0" aria-hidden="true" />
              ...
              <router-link
                ...
                :aria-current="isActive('/compliance/operations') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/operations')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
                <ChartBarSquareIcon class="mr-3 h-5 w-5 shrink-0" aria-hidden="true" />
                Operations Cockpit
              </router-link>
              <router-link
              ...
              <router-link
                ...
                :aria-current="isActive('/compliance/reporting-center') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/compliance/reporting-center')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
                <CalendarDaysIcon class="mr-3 h-5 w-5 shrink-0" aria-hidden="true" />
                Reporting Center
              </router-link>
              <router-link
                to="/enterprise/branding"
                :aria-current="isActive('/enterprise/branding') ? 'page' : undefined"
                class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
                :class="isActive('/enterprise/branding')
                  ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20'
                  : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800'"
              >
                <SwatchIcon class="mr-3 h-5 w-5 shrink-0" aria-hidden="true" />
                Enterprise Branding
              </router-link>
            </div>
          </div>
...
import { PlusCircleIcon, ChartBarIcon, CubeIcon, BuildingOfficeIcon, ShieldCheckIcon, ShieldExclamationIcon, UsersIcon, ClipboardDocumentCheckIcon, ClipboardDocumentListIcon, ChartBarSquareIcon, CalendarDaysIcon, BellAlertIcon, SwatchIcon } from "@heroicons/vue/24/outline";
