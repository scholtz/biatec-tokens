...
export function useTokenMetadata() {
  ...
  const determineComplianceFlags = (assetParams: any, arc3Metadata?: ARC3Metadata): ComplianceFlags => {
    ...
    const hasComplianceKeywords =
      description.includes("kyc") || description.includes("whitelist") || description.includes("mica") || description.includes("compliant") || description.includes("regulated");
